...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: 'https://semar-id.vercel.app/og-image.jpg', 
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ['https://semar-id.vercel.app/og-image.jpg'],
  },
  robots: {
    index: true,
    follow: true,
  ...
  verification: { google: '76f2bdf997e7dd54' },
};
...
const localBusinessSchema = {
  ...
  "description": "Jasa pembuatan website profesional di Tenggarong, Samarinda, dan Balikpapan. Spesialis website untuk UKM & Startup Kalimantan Timur.",
  ...
  "sameAs": [
    "https://www.instagram.com/semarwebsoftware/",
    "https://www.tiktok.com/@semarwebsoftware",
    "https://api.whatsapp.com/send/?phone=6282253129334&text=Halo+kak+saya+mau+konsultasi+tentang&type=phone_number&app_absent=0"
  ],
  "areaServed": [
    {"@type": "City","name": "Tenggarong"},
    {"@type": "City","name": "Tenggarong Seberang"},
    {"@type": "City","name": "Samarinda"},
    {"@type": "City","name": "Balikpapan"},
    {"@type": "State","name": "Kutai Kartanegara"},
...
// Organization Schema untuk Google Brand
...
export default function RootLayout({
  ...
  return (
    <html lang="id">
      <head>
        {/* Schema Markup untuk Local SEO & Brand */}
        <Script
