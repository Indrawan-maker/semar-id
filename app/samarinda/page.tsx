  ...
  return (
    <>
      ...
      <main className="grid place-items-center gap-12 mt-34">
        <div className="grid place-items-center gap-2">
          ...
          <p className="font-bold text-2xl md:text-4xl text-[#FFD074] max-w-80 min-w-80 md:max-w-180 md:min-w-180 text-center mt-4">
            Website Profesional untuk Bisnis di Ibu Kota Kaltim
          </p>
          ...
          <p className="flex flex-wrap font-normal text-sm md:text-xl text-center max-w-80 min-w-80 md:max-w-180 md:min-w-180 text-[#FFFFE3] mt-4 md:mt-8">
            Jasa pembuatan website profesional di <strong>Samarinda</strong>, Kalimantan Timur. 
            Spesialis website untuk UKM & Startup. Kami bantu bisnis lokal Anda muncul di Google & terlihat profesional. 
          ...
          <span className="text-[#17F1D1] font-normal text-sm md:text-xl text-center">
            Tingkatkan kredibilitas bisnis Anda di Samarinda dalam 3-7 hari kerja!
          </span>
          ...
          <div className="grid md:flex gap-8 md:gap-4 mt-22 md:mt-18">
            <a
              href="https://wa.me/6282253129334?text=Halo%20SEMAR,%20saya%20dari%20Samarinda%20tertarik%20dengan%20jasa%20pembuatan%20website"
              target="_blank"
        ...
        <p className="text-[#17F1D1] font-semibold text-lg">
          📍 MELAYANI WILAYAH SAMARINDA & SEKITARNYA
        </p>
      </main>
      ...
      <section className="max-w-7xl mx-auto px-4 py-24 md:py-32">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold text-[#FFD074] mb-6">
            Kenapa Bisnis di Samarinda Butuh Website?
          </h2>
          <p className="text-xl text-[#FFFFE3] max-w-3xl mx-auto">
            Samarinda sebagai ibu kota Kalimantan Timur memiliki persaingan bisnis yang semakin ketat. 
            Website profesional adalah kunci untuk unggul di pasar digital.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="border border-[#A374FF] rounded-2xl p-8 hover:border-[#17F1D1] transition-all">
            ...
            <p className="text-[#FFFFE3]">
              Customer lebih percaya pada bisnis yang punya website profesional. 
              Tampil modern dan terpercaya di mata calon pembeli.
            </p>
          </div>
          ...
          <div className="border border-[#A374FF] rounded-2xl p-8 hover:border-[#17F1D1] transition-all">
            ...
            <p className="text-[#FFFFE3]">
              Saat orang di Samarinda search &quot;jasa X Samarinda&quot; di Google, 
              bisnis Anda yang muncul pertama.
            </p>
          </div>
          ...
          <div className="border border-[#A374FF] rounded-2xl p-8 hover:border-[#17F1D1] transition-all">
            ...
            <p className="text-[#FFFFE3]">
              Website bisa diakses 24/7 dari mana saja. 
              Customer bisa cek info produk/jasa kapan pun mereka mau.
            </p>
          </div>
          ...
          <div className="border border-[#A374FF] rounded-2xl p-8 hover:border-[#17F1D1] transition-all">
            ...
            <p className="text-[#FFFFE3]">
              Kompetitor Anda di Samarinda sudah punya website. 
              Jangan sampai tertinggal di era digital!
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="border-2 border-[#A374FF] rounded-3xl p-8 hover:border-[#17F1D1] transition-all">
            ...
            <p className="text-sm text-[#FFD074] font-semibold">
              ⚡ Cocok untuk: Perusahaan, Klinik, Konsultan, Jasa
            </p>
          </div>
          ...
          <div className="border-2 border-[#17F1D1] rounded-3xl p-8 hover:border-[#FFD074] transition-all relative">
            ...
            <p className="text-sm text-[#FFD074] font-semibold">
              🛍️ Cocok untuk: Toko, Fashion, F&B, Produk Digital
            </p>
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-24 md:py-32">
        <div className="bg-linear-to-r from-purple-900/20 to-cyan-900/20 rounded-3xl p-12 md:p-16">
          <div className="text-center mb-12">
            <h2 className="text-4xl md:text-6xl font-bold text-[#FFD074] mb-6">
              Kenapa Pilih SEMAR di Samarinda?
            </h2>
            <p className="text-xl text-[#FFFFE3]">
              Lebih dari sekedar jasa pembuatan website
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[#FFFFE3]">
                Website langsung optimized untuk muncul di Google Search.
              </p>
            </div>
      ...
      <section className="max-w-5xl mx-auto px-4 py-24 md:py-32 text-center">
        <h2 className="text-4xl md:text-6xl font-bold text-[#FFD074] mb-6">
          Siap Tingkatkan Bisnis Anda di Samarinda?
        </h2>
        ...
        <div className="grid md:flex gap-8 md:gap-4 justify-center">
          <a
            href="https://wa.me/6282253129334?text=Halo%20SEMAR,%20saya%20dari%20Samarinda%20mau%20konsultasi%20tentang%20pembuatan%20website"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="mt-16 pt-8 border-t border-[#A374FF]/30">
          <p className="text-[#17F1D1] font-semibold text-lg mb-2">
            📍 Melayani Seluruh Wilayah Samarinda
          </p>
          <p className="text-sm text-[#FFFFE3]/70">
            Samarinda Seberang, Samarinda Ulu, Samarinda Ilir, Samarinda Utara, Sungai Kunjang, 
            Palaran, Sambutan, Sungai Pinang, Loa Janan Ilir, dan sekitarnya
          </p>
